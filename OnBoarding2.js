  ...
  return (
    ...
    <View style={styles.container}>
      <SafeAreaView>
        ...
        <Image source={require('./assets/Medicine.png')} style={styles.pharmacyImage}></Image>
        <View style={styles.card}>
            ...
            <View style={styles.desclocal}> 
              <Image style={styles.localImg} source={require("./assets/icons/done.png")}/>
              <Text  style={styles.description}>Access medication availability{'\n'} effortlessly, ensuring you find what {'\n'} you need with ease.</Text>
            </View> 
