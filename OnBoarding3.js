  ...
  return (
    ...
    <View style={styles.container}>
      <SafeAreaView>
        ...
        <Image source={require('./assets/delivery.png')} style={styles.pharmacyImage}></Image>
        <View style={styles.card}>
            <Text style={styles.title} >Discover 24/7 Delivery Nearby </Text>

            <View style={styles.desclocal}> 
              <Image style={styles.localImg} source={require("./assets/icons/scooter.png")}/>
              <Text style={styles.description}> Unlock 24/7 Delivery Options, Always {'\n'} Nearby for You.</Text>
            </View> 
